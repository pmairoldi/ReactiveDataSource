...
public struct TableViewConfiguration {
    ...
    public init(reuseIdentifier: String, headerTitle: (Int -> String?)? = nil, footerTitle: (Int -> String?)? = nil) {
...
public class TableViewDataSource<T>: NSObject, UITableViewDataSource {
    ...
    public init(tableView: UITableView, dataProducer: SignalProducer<[[T]], NoError>, configuration: TableViewConfiguration) {
